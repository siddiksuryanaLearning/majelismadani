                ...
                <div>
                    ...
                    <div class="flex px-6 mb-4 sm:pl-0 sm:flex ">
                        ...
                        <a href="#form"
                            ...
                            <span
                                class="relative text-2xl px-12 py-2.5 transition-all ease-in duration-75 bg-gradient-to-r from-orange-500 to-pink-500 hover:bg-gradient-to-bl dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                Daftar Sekarang
                            </span>
                        </a>
                    </div>
