...
@section('title', 'Form Peserta')
    ...
    <div class="grid max-w-screen-xl px-4 py-6 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-12">
            <h1 class="mb-4 text-2xl text-orange-600 font-extrabold tracking-tight leading-none md:text-5xl xl:text-4xl text-center text-orange-600">Terimakasih telah Mendaftar</h1>
            <p class="font-light mb-6 lg:mb-8 md:text-lg lg:text-2xl text-white">Berikut data yang telah anda masukan</p>
            <p class="font-light mb-6 lg:mb-8 md:text-lg lg:text-2xl text-white">Kirim pembayaran ke No rekening :</p>       
            ...
            <p class="font-light mt-4 mb-6 lg:mb-8 md:text-lg lg:text-2xl text-white">Konfrimasai bukti transef di kirim ke :</p>
            <div class="sm:flex sm:flex-row sm:justify-center sm:border-2 items-center border-2" style="text-align: center;">
                <img src="img/icon_phone.png" class="bg-cover bg-center sm:scale-75 items-center scale-50" style="display: inline-block;" alt="mockup">
